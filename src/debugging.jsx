...
import './App.css';
import bntr from './assets/adidas-logo.png';
            ...
            <div className="w-full lg:w-2/12 flex flex-col gap-3">
                <div className='border border-gray-200 shadow-lg rounded-2xl bg-white h-4/6 p-4'>
                    <div className='flex gap-2 items-center'>
                        <img src={bntr} alt="Logo" className='w-10' />
                        <div>
            ...
            <div className="w-full lg:w-10/12 flex flex-col gap-3">
                ...
                <div className='flex flex-col lg:flex-row gap-8 h-5/6'>
                    ...
                    <div className="w-full lg:w-2/4 flex flex-col gap-3">
                        <div className="h-3/4 bg-white rounded-2xl shadow-lg p-5">
                            <h2 className='font-semibold text-lg'>Todays Announcement</h2>
                        ...
                        <div className="h-1/4 bg-white rounded-2xl shadow-lg flex items-center justify-center p-4">
                            <button className='border border-orange-500 text-orange-500 px-4 py-2 rounded-full text-sm'>New Member</button>
                        </div>
                    </div>
                    
                    {/* Up Next */}
                    <div className="w-full lg:w-2/4 bg-white shadow-lg rounded-2xl p-5">
                                ...
                                displayedNext.map((anc, index) => (
                                    <div key={index} className="flex gap-4 p-3 border-b items-center">
                                        <div className="flex flex-col items-center">
                                            <img src={anc.image} alt="User" className="w-12 h-12 lg:w-16 lg:h-16 rounded-full " />
